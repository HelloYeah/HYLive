...
//#define topBarItemMargin 15 * kScreenWidthRatio
//#define topBarHeight 44 * kScreenWidthRatio
...
- (void)itemSelectedIndex:(NSInteger)index{
    ...
    [UIView animateWithDuration:0.25 animations:^{
        preSelectedBtn.titleLabel.font = kFont(16);
        selectedBtn.titleLabel.font = kBoldFont(18);
    }];
}
